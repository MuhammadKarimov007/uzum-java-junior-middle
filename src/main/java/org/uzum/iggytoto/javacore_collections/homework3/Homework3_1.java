...
public class Homework3_1 {
    ...
    public Map<String, Integer> countWords(String text) {
        ...
        String[] punctuatioinMarks = new String[] {"\\?", "\n", "!", "—", ",", "\\.", "-", ":", "\\.\\.\\."};
        for (String punctuatioinMark : punctuatioinMarks) {
            text = text.replaceAll(punctuatioinMark, " ");
        }
        String[] words = text.toLowerCase().split(" ");
        List<String> filteredWords = Arrays.stream(words).filter(e -> !e.isEmpty()).toList();
    ...
    public static void main(String[] args) {
        ...
        Homework3_1 test = new Homework3_1();
        Map<String, Integer> letssee = test.countWords(TEXT);
        Map<String, Integer> letssee2 = test.countWords("Java, Java — отличный язык, отличный язык");
        System.out.println(letssee.get("пуста"));
        System.out.println(letssee2.size());
    }
}
